...
storage-tree:
	@mkdir -p storage/uploads/video storage/uploads/audio storage/uploads/pdf \
		...
		storage/shadow/identity storage/shadow/sessions storage/shadow/session-learning storage/shadow/relationship storage/shadow/memory storage/shadow/teaching storage/shadow/knowledge storage/shadow/goals storage/shadow/mentor storage/shadow/executive storage/shadow/brain storage/learning storage/workspace \
