...
storage-tree:
	@mkdir -p storage/uploads/video storage/uploads/audio storage/uploads/pdf \
		...
		storage/shadow/identity storage/shadow/sessions storage/shadow/session-learning storage/shadow/relationship storage/shadow/memory storage/shadow/teaching storage/learning storage/workspace \
