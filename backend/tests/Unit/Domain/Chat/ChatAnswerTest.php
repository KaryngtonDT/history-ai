...
final class ChatAnswerTest extends TestCase
{
    public function testExposesAnswerAndSources(): void
    {
        ...
        $answer = new ChatAnswer('Several factors contributed to the collapse.', $sources);

        self::assertSame('Several factors contributed to the collapse.', $answer->answer());
        self::assertSame($sources, $answer->sources());
    }

    public function testTrimsAnswer(): void
    {
        $answer = new ChatAnswer('  Plain text answer  ', ChatSourceCollection::empty());

        self::assertSame('Plain text answer', $answer->answer());
    }
    ...
    public function testRejectsEmptyAnswer(): void
    {
        ...
        new ChatAnswer('   ', ChatSourceCollection::empty());
    }
