    ...
    public static function all(): array
    {
        return [
            ...
            new EngineProvisionSpec(
                'kokoro',
                true,
                installCommand: 'pip3 install --break-system-packages "kokoro-onnx>=0.4" soundfile',
                modelDownloadHint: 'hexgrad/Kokoro-82M via HuggingFace',
            ...
            new EngineProvisionSpec(
                'smolvlm',
                true,
                installCommand: 'pip3 install --break-system-packages transformers accelerate pillow',
                modelDownloadHint: 'HuggingFaceTB/SmolVLM-256M-Instruct via HuggingFace',
            ...
            new EngineProvisionSpec(
                'bge_m3',
                true,
                installCommand: 'pip3 install --break-system-packages FlagEmbedding',
                modelDownloadHint: 'BAAI/bge-m3 via HuggingFace',
            ...
            new EngineProvisionSpec(
                'jina_embeddings',
                true,
                installCommand: 'pip3 install --break-system-packages sentence-transformers',
                modelDownloadHint: 'jinaai/jina-embeddings-v2-base-en via HuggingFace',
            ...
            new EngineProvisionSpec(
                ...
                true,
                installCommand: 'pip3 install --break-system-packages sentence-transformers',
                modelDownloadHint: 'intfloat/e5-large-v2 via HuggingFace',
            ...
            new EngineProvisionSpec(
                ...
                true,
                installCommand: 'pip3 install --break-system-packages FlagEmbedding',
                modelDownloadHint: 'BAAI/bge-reranker-base via HuggingFace',
            ...
            new EngineProvisionSpec(
                ...
                true,
                installCommand: 'pip3 install --break-system-packages sentence-transformers',
                modelDownloadHint: 'cross-encoder/ms-marco-MiniLM-L-6-v2 via HuggingFace',
