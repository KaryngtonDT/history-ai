    ...
    public static function all(): array
    {
        return [
            ...
            new EngineProvisionSpec(
                'musetalk',
                false,
                blockedReason: 'MuseTalk requires manual install from upstream repo and model weights.',
                installCommand: 'See docs/operations/ENGINE_INSTALLATION.md#musetalk',
                modelDownloadHint: 'https://github.com/TMElyralab/MuseTalk',
                modelPath: '/models/musetalk',
                documentationPath: 'docs/operations/ENGINE_INSTALLATION.md#musetalk',
            ),
            new EngineProvisionSpec(
                'ffmpeg',
                true,
