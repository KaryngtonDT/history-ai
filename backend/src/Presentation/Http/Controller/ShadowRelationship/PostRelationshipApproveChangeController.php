...
final class PostRelationshipApproveChangeController extends AbstractController
{
    #[Route('/api/shadow/relationship/changes/{changeId}/approve', name: 'api_shadow_relationship_change_approve', methods: ['POST'])]
    public function __invoke(
        ...
        return $this->json($handler->approve($scopeKey, $changeId));
    }
}
