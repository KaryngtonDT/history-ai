...
final class PostRelationshipConfigureController extends AbstractController
{
    #[Route('/api/shadow/relationship/configure', name: 'api_shadow_relationship_configure', methods: ['POST'])]
    public function __invoke(Request $request, RelationshipUtteranceInterpreter $interpreter): JsonResponse
    {
