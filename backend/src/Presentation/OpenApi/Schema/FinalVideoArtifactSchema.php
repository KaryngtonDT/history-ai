...
#[OA\Schema(
    ...
    properties: [
        ...
        new OA\Property(property: 'downloadUrl', type: 'string', example: '/api/videos/{videoId}/render/french/stream'),
    ],
)]
final class FinalVideoArtifactSchema
{
}
