...
#[OA\Tag(name: 'Agent', description: 'Deterministic agent workflow projections for content resources')]
#[OA\Tag(name: 'Video', description: 'Video upload and processing job foundation')]
