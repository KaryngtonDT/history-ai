...
final class PostTeachingCheckpointCompleteHandler
{
    ...
    public function __invoke(string $scopeKey, string $checkpointId): array
    {
        return $this->mapper->toArray($this->builder->completeCheckpoint($scopeKey, $checkpointId));
    }
}
