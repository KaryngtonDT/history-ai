...
use App\Application\ShadowExecutive\ExecutiveContextComposer;
...
final class ShadowWatchPromptBuilder
{
    public function __construct(
        ...
        private readonly ?ExecutiveContextComposer $executiveContextComposer = null,
    ...
    public function build(
        ...
        if (null !== $this->relationshipContextComposer) {
            $lines = [...$lines, ...$this->relationshipContextComposer->promptLines()];
        }
        ...
        if (null !== $this->executiveContextComposer) {
            $lines = [...$lines, ...$this->executiveContextComposer->promptLines()];
        }
        ...
        if (null !== $this->knowledgeContextComposer) {
            $lines = [...$lines, ...$this->knowledgeContextComposer->promptLines($question->text())];
        }
