...
export const pipelineFr: PipelineMessages = {
	pipeline: {
		...
		progress: {
			...
			actualCompletion: "Fin réelle : {{time}}",
			actualDuration: "Durée réelle : {{minutes}} min",
			estimationAccuracy: "Précision de l'estimation : {{percent}}",
			elapsedTime: "Écoulé : {{minutes}} min",
			engine: "Moteur : {{engine}}",
			hardwareProfile: "Matériel : {{profile}}",
