...
export const pipelineDe: PipelineMessages = {
	pipeline: {
		...
		progress: {
			...
			actualCompletion: "Tatsächliche Fertigstellung: {{time}}",
			actualDuration: "Tatsächliche Dauer: {{minutes}} Min.",
			estimationAccuracy: "Schätzgenauigkeit: {{percent}}",
			elapsedTime: "Verstrichen: {{minutes}} Min.",
			engine: "Engine: {{engine}}",
			hardwareProfile: "Hardware: {{profile}}",
			currentStep: "Schritt: {{step}}",
		},
		create: {
